/**
 * Implementation of the Graph Abstract Datatype.
 */
...
void grap_init(Graph *graph, int(*match)(const void *key1, const void *key2),
	...
	/**
	 * Initialize the list of adjacnency-list structures.
	 */
...
void graph_destroy(Graph *graph)
{
	...
	/**
	 * Destroy the list of adjacency-list structures, which is now empyt.
	 */
	list_destroy(&graph->adjlists);

	/**
	 * No operations are allowed now, but clear the stucture as a precaution.
	 */
...
int graph_ins_vertex(Graph *graph, const void *data)
{
	...
	/**
	 * Do not allow the insertion of duplication vertices.
	 */
...
int graph_rem_vertex(Graph *graph, void **data)
{
	...
	{
		/**
		 * Do not allow removal of the vertex if it is in an adjancency list.
		 */
	...
	*data = adjlist->vertex;
	...
	/**
	 * Adjust the vertex count to account for the removed
	 */
	graph->vcount--;
...
int graph_rem_edge(Graph *graph, void *data1, void **data2)
{
	...
	/**
	 * Remove the second vertex from the adjancency list of the first vertex.
	 */
...
int graph_is_adjacent(const Graph *graph, const void *data1, const void *data2)
{
	...
	/**
	 * Locate teh adjacency list of the first vertex.
	 */

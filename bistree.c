...
static void destroy_left(BisTree *tree, BiTreeNode *node)
{
	...
	/**
	 * Do not allow destruction of an empyt tree.
	 */
...
static int insert(BisTree *tree, BiTreeNode **node, const void *data, int *balanced)
{
	...
	{
		/**
		 * Handle insertion into an empyt tree.
		 */
...
void bistree_destroy(BisTree *tree)
{
	...
	/**
	 * No operaions are allowed now, but clear the structure as a precaution.
	 */

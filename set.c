...
{
	/*
	*	Do not allow the insertion of duplicate.s
	*/
 ...
 */
 ...
 int set_insertion(Set *set1, const Set *set1, const Set *set2)
 {
	...
	/**
	 * Initialize the set for intersection.
	 */
  ...
  */
  int set_is_subset(const Set* set1, const Set* set2)
  {
	...
	/**
	 * Do a quick test to rule out subeset of set2.
	 */
  ...
  */
  int set_is_equal(const Set *set1, const Set *set2)
  {
	 ...
	 */
	 ...
	 /**
	  * Sets of the size are equal if they are subesets.
	  */
